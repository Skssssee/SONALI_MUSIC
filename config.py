...
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Jasmine_music_bot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Skssssee/SONALI_MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/jasmine_support")
